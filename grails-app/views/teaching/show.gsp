...
<html>
    ...
    <body>
        ...
        <div id="show-teaching" class="content scaffold-show" role="main">
            ...
            <f:display bean="teaching" />
            <g:form resource="${this.teaching}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.teaching}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
